...
interface BlogpostsDocumentData {
    ...
    /**
     * Picture field in *Blogposts*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
     * - **API ID Path**: blogposts.picture
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/image
     *
     */
    picture: prismicT.ImageField<never>;
    /**
     * ContentText field in *Blogposts*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: blogposts.contenttext
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    contenttext: prismicT.RichTextField;
    /**
 ...
 *
 */
type PageDocumentDataSlicesSlice = HeroSlice | QuoteSlice | TextSlice | ImageSlice | ImageCardsSlice | TextWithImageSlice | BlogPostsSlice;
/**
...
export type AllDocumentTypes = AuthorDocument | BlogpostsDocument | NavigationDocument | PageDocument | SettingsDocument;
/**
 * Primary content in BlogPosts → Primary
 *
 */
interface BlogPostsSliceDefaultPrimary {
    /**
    ...
    title: prismicT.TitleField;
    /**
     * Description field in *BlogPosts → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: blog_posts.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
...
export interface BlogPostsSliceDefaultItem {
    /**
     * blogpost field in *BlogPosts → Items*
     *
     * - **Field Type**: Content Relationship
     * - **Placeholder**: *None*
     * - **API ID Path**: blog_posts.items[].blogpost
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    blogpost: prismicT.RelationField<"blogposts">;
}
/**
 ...
 *
 */
export type BlogPostsSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<BlogPostsSliceDefaultPrimary>, Simplify<BlogPostsSliceDefaultItem>>;
/**
